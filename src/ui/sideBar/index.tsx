...
const SideBar = () => {
  ...
  return (
    <div
      className={`border-r w-[81px] pt-[32px] pb-[34px] min-w-[81px] border-[#E3E4E4] flex flex-col gap-2 items-center fixed left-0 top-0 bottom-0 z-10 bg-surface-layout`}
    >
      <img
        src={MainLogo}
        style={{
