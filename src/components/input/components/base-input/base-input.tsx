      ...
      <div
        className={cn(
          ...
          [
            ...
            "border border-border-layout ",
            "focus-within:border-border-active focus-within:ring-1 focus-within:ring-border-ring focus-within:ring-offset-1",
            "hover:border-active hover:focus-within:border-border-active",
